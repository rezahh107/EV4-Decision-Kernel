...
- KROAD-010 consumer records must preserve the pinned Decision Record's provisional state, stage owner, evidence lineage, L2 envelope, matrix fragment, and required provenance without silent upgrades.
